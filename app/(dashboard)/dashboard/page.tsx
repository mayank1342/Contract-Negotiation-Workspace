            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>History of stateful AI negotiations, scores, and contract status</CardDescription>
                </div>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  valueSaved: '₹25,000 / yr',
                  date: 'Yesterday',
                },
                {
                  id: '3',
                  title: 'Freelance UI/UX Design Agreement',
                  type: 'Freelance Contract',
                  score: 91,
                  status: 'AGREED',
                  opponent: 'Agency Founder (Friendly)',
                  valueSaved: '₹8,000 / mo',
                  date: '3 days ago',
                },
              ].map((item) => (
